# to change the dataset give the file path at line 9 and line 297
...
# Load the dataset
df = pd.read_csv(r'C:\Users\user\Downloads\samsung_p\sam_python\hackaethon_full_project\DGCA_DATA.csv')
